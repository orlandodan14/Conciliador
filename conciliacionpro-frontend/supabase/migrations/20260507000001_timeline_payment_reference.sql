-- =========================================================
-- 20260507000001_timeline_payment_reference.sql
--
-- Muestra la referencia del cobro (payments.reference) en la
-- columna "number" de los eventos PAYMENT del timeline, para
-- que el expander row de docs-tribut-ventas pueda mostrar el
-- N° del cobro en la columna Documento.
-- =========================================================
...
payment_events as (
  select
    ...
    null::text as series,
    p.reference::text as number,        -- ← N° del cobro (payments.reference)
