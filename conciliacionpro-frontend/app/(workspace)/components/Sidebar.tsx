  ...
  const sections: NavSection[] = useMemo(
    () => [
      ...
      },
      {
        ...
        items: [
          { label: "Balance General", href: "/balance" },
          { label: "Estado de Resultados", href: "/estado-resultados" },
          { label: "Mayor", href: "/mayor" },
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Periódos Contables", href: "/configuracion/periodos-contables" },
          { label: "Saldos Iniciales", href: "/configuracion/saldos-iniciales" },
          { label: "Centros de Costos", href: "/configuracion/centros-costos" },
          { label: "Lineas de negocios", href: "/configuracion/negocios" },
          { label: "Sucursales", href: "/configuracion/sucursales" },
          { label: "Impuestos", href: "/configuracion/impuestos" },
          { label: "Moneda y T/Cambio", href: "/configuracion/monedas" },
  ...
  return (
    <aside
      className={[
        ...
        "flex flex-col", // ✅ clave: permite que el nav use el alto restante y scrollee
